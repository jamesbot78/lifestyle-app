...
- **Vercel serverless function** (`api/ask-claude.js`) proxies every AI call to Anthropic's API, so the client never holds or sends the API key. See [ai-integration.md](./ai-integration.md).
